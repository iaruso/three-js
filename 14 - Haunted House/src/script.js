...
const bricksAmbientOcclusionTexture = textureLoader.load('/textures/bricks/ambienteOcclusion.jpg')
...
const grassAmbientOcclusionTexture = textureLoader.load('/textures/grass/ambienteOcclusion.jpg')
...
renderer.shadowMap.typ = THREE.PCFSoftShadowMap
...
const tick = () =>
{
    ...
    ghost3.position.set(
        Math.cos(ghost3Angle) * (7 + Math.sin(elapsedTime * 0.3)),
        Math.sin(elapsedTime * 4) + Math.sin(elapsedTime * 3),
